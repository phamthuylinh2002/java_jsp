        ...
        <div class="mt-5">
            ...
            <section class="fillter-area  mb-5">
                <div class="m-portlet">
                    ...
                    <form action="${path}/staff/PDT/danh-sach-sinh-vien-chua-dang-ky/tim-kiem-sinh-vien-chua-dang-ky" method="post" class="m-portlet__body">
                        <div class="row">
	                                ...
	                                <select class="form-control d-inline col-8 select2" name="chuyen_nganh_id" id="chuyen_nganh_id">
	                                    <option value="0" selected>Chọn chuyên ngành</option>
	                                        ...
	                                        <c:forEach items="${chuyenNganh}" var="chuyenNganh">
	                                        	...
	                                        	<option value="${chuyenNganh.id}" ${chuyenNganh.id== sessionScope.ScopeCN_chuaDK ?"selected":""} >${chuyenNganh.ten}</option>	
                        ...
                        <div class="row justify-content-center pt-2">
                            ...
                            <div class="col-sm-2 col-12 text-center mt-2">
                                <a
                                    href="${path}/staff/PDT/danh-sach-sinh-vien-chua-dang-ky"
            ...
            <div class="row mb-5 bieumau">
                <div class="col-12 col-sm-4 col-lg-4">
                    <a
                        href="${path}/files/export-danh-sach-sv-chua-dang-ky">
                        <i class="fa fa-download" aria-hidden="true"></i>
                        Xuất danh sách sinh viên chưa đăng ký
                    </a>
                </div>
            </div>
