        ...
        <div class="mt-5">
            ...
            <section class="fillter-area  mb-5">
                <div class="m-portlet">
                    ...
                    <form action="${path}/staff/PDT/danh-sach-sinh-vien-da-dang-ky/tim-kiem-sinh-vien-da-dang-ky" method="post" class="m-portlet__body">
                        <div class="row">
                                ...
                                <select class="form-control d-inline col-8 select2" name="chuyen_nganh_id" id="chuyen_nganh_id">
                                    <option value="0" selected>Chọn chuyên ngành</option>
                                        ...
                                        <c:forEach items="${chuyenNganh}" var="chuyenNganh">
                                        	...
                                        	<option value="${chuyenNganh.id}" ${chuyenNganh.id== sessionScope.ScopeCN_DaDK ?"selected":""} >${chuyenNganh.ten}</option>	
                                        </c:forEach>
                                ...
                                <select class="form-control col-8 select2" name="khoa" id="khoa">
                                    <option value="0" selected>Chọn khóa</option>
                                        ...
                                        <c:forEach items="${khoa}" var="khoa">
                                        	...
                                        	<option value="${khoa}" ${khoa.equals(sessionScope.ScopeKhoa_DaDK) ?"selected":""} >${khoa}</option>	
                                        </c:forEach>
                        ...
                        <div class="row">
                            <div class="form-group d-inline col-md-6 col-12 d-flex justify-content-around align-items-center">
                                ...
                                <select class="form-control d-inline col-8 select2"
									name="dot_id" id="dot_id">
									<option value="0" selected>Chọn đợt đăng ký</option>
									<c:forEach items="${dotdk}" var="dotdk">

                                        	<option value="${dotdk[0]}" ${dotdk[0]== sessionScope.ScopeDotDK_DaDK ?"selected":""} >${dotdk[1]}</option>
                        ...
                        <div class="row justify-content-center pt-2">
                            ...
                            <div class="col-sm-2 col-12 text-center mt-2">
                                <a
                                    href="${path}/staff/PDT/danh-sach-sinh-vien-da-dang-ky"
            ...
            <div class="row mb-5 bieumau">
                <div class="col-12 col-sm-4 col-lg-4">
                    <a
                        href="${path}/files/export-danh-sach-sv-da-dang-ky">
                        <i class="fa fa-download" aria-hidden="true"></i>
                        Xuất danh sách sinh viên đã đăng ký
                    </a>
                </div>
            </div>
