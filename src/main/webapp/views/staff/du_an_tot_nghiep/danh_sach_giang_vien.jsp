                    ...
                    <div class="mt-5">
                        <section class="fillter-area  mb-5">
                            <div class="m-portlet">
                                ...
                                <form action="${path }/staff/PDT/quan-ly-giang-vien/tim-kiem" method="post"
                                    ...
                                    <div class="row justify-content-center pt-2">
                                        ...
                                        <div class="col-sm-2 col-12 text-center mt-2">
                                            <a href="${path }/staff/PDT/quan-ly-giang-vien"
                        ...
                        <div class="row mb-5 bieumau">
                            ...
                            <div class="col-6 col-sm-4 col-lg-4">
                                <a href="${path}/files/tham-khao-gv.xlsx"> <i class="fa fa-download"
                        ...
                        <form action="${path}/files/upload-them-gv" enctype="multipart/form-data" id="form_import_dssv"
                            method="POST">
                                                        ...
                                                        <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                <form method="POST" id="form_edit_gv_${item[0] }"
                                                                    ...
                                                                    action="${path}/staff/PDT/quan-ly-giang-vien/edit/?idGv=${item[0] }">
                                                        ...
                                                        <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                <form method="POST" id="form_delete_gv_${item[0] }"
                                                                    action="${path}/staff/PDT/quan-ly-giang-vien/delete/?idGv=${item[0] }">
