...
<div>
	<div class="m-content">
		...
		<h3>Chi tiết nhóm
		<a class="btn btn-primary" href="${path}/staff/PDT/danh-sach-cac-nhom-da-tao" style="float: right; margin-bottom: 10px">
										Quay lại </a>
					...
					<div class="m-portlet__body">
						...
						<div class="col-12 mt-3">
							<label class="col-sm-3">Trạng thái hiển thị</label> <label
								class="col-sm-8 font-weight-bold">${item[2] == null?'Nhóm công khai':'Nhóm bí mật' }</label>
						</div>
				</c:forEach>
			</div>
