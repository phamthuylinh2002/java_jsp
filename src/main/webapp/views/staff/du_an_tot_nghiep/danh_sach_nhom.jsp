                ...
                <div class="mt-5">
                    ...
                    <section class="fillter-area  mb-5">
                        <div class="m-portlet">
                            ...
                            <form action="${path}/staff/PDT/danh-sach-cac-nhom-da-tao/tim-kiem" method="post" class="m-portlet__body">
                                <div class="row">
                                ...
                                <div class="row justify-content-center pt-2">
                                    ...
                                    <div class="col-sm-2 col-12 text-center mt-2">
                                        <a href="${path}/staff/PDT/danh-sach-cac-nhom-da-tao" class="btn btn-danger text-white">
											Làm mới bộ lọc </a>
                                    </div>
                                </div>
                            </form>
									...
									<c:forEach var="item" items="${dSachNhom }" varStatus="loop">
										<tr>
											...
											<td><a class="btn btn-primary"
													href="${path}/staff/PDT/chi-tiet-nhom?nhom_id=${item[0]}">
													Chi tiết nhóm </a></td>
										</tr>
									</c:forEach>
