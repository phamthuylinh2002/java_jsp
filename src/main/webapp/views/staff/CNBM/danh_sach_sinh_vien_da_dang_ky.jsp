                    ...
                    <div class="mt-5">
                        ...
                        <section class="fillter-area  mb-5">
                            <div class="m-portlet">
                                ...
                                <form action="${path}/staff/CNBM/danh-sach-sinh-vien-da-dang-ky/tim-kiem-sinh-vien-da-dang-ky" method="post" class="m-portlet__body">
                                    <div class="row">
                                        ...
                                        <span for="" class="fillter-name col-4 text-center">Chuyên
											...
											<c:forEach items="${chuyenNganh}" var="chuyenNganh">
												...
												<option value="${chuyenNganh[0]}"
													${chuyenNganh[0]==sessionScope.ScopeCN_DaDK ?"selected":""}>
                                    ...
                                    <div class="row justify-content-center pt-2">
                                        ...
                                        <div class="col-sm-2 col-12 text-center mt-2">
                                            <a href="${path}/staff/CNBM/danh-sach-sinh-vien-da-dang-ky" class="btn btn-danger text-white">
                                    Làm mới bộ lọc
                                </a>
                                        </div>
                                    </div>
                        ...
                        <div class="row mb-5 bieumau">
                            <div class="col-12 col-sm-4 col-lg-4">
                                <a href="${path}/files/export-danh-sach-sv-da-dang-ky">
                                    <i class="fa fa-download" aria-hidden="true"></i> Xuất danh sách sinh viên đã đăng ký
                                </a>
                            </div>
                        </div>
