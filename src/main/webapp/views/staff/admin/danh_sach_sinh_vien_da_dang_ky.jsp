                    ...
                    <div class="mt-5">
                        ...
                        <section class="fillter-area  mb-5">
                            <div class="m-portlet">
                                ...
                                <form
                                    action="${path}/staff/admin/danh-sach-sinh-vien-da-dang-ky/tim-kiem-sinh-vien-da-dang-ky"
                                    method="post" class="m-portlet__body">
                                    <div class="row">
                                        <div
                                            ...
                                            <select class="form-control d-inline col-8 select2" name="chuyen_nganh_id"
                                                id="chuyen_nganh_id">
                                                ...
                                                <c:forEach items="${chuyenNganh}" var="chuyenNganh">
                                                    ...
                                                    <option value="${chuyenNganh.id}"
                                                        ${chuyenNganh.id==sessionScope.ScopeCN_DaDK ?"selected":""}>
                                        ...
                                        <div
                                            ...
                                            <select class="form-control col-8 select2" name="khoa" id="khoa">
                                                ...
                                                <c:forEach items="${khoa}" var="khoa">
                                                    ...
                                                    <option value="${khoa}" ${khoa.equals(sessionScope.ScopeKhoa_DaDK)
                                                        ?"selected":""}>${khoa}</option>
                                                </c:forEach>
                                    ...
                                    <div class="row">
                                        <div
                                            ...
                                            <select class="form-control d-inline col-8 select2" name="dot_id"
                                                id="dot_id">
                                                <option value="0" selected>Chọn đợt đăng ký</option>
                                                <c:forEach items="${dotdk}" var="dotdk">

                                                    <option value="${dotdk[0]}" ${dotdk[0]==sessionScope.ScopeDotDK_DaDK
                                        ...
                                        <div
                                            ...
                                            <select class="form-control d-inline col-8 select2" name="co_so_id"
                                                ...
                                                <c:forEach items="${CoSo}" var="CoSo">
                                                    ...
                                                    <option value="${CoSo.id}" ${CoSo.id==sessionScope.ScopeCoSo_daDK
                                                        ?"selected":""}>
                                                        ${CoSo.ten}</option>
                                    ...
                                    <div class="row justify-content-center pt-2">
                                        ...
                                        <div class="col-sm-2 col-12 text-center mt-2">
                                            <a href="${path}/staff/admin/danh-sach-sinh-vien-da-dang-ky"
                        ...
                        <div class="row mb-5 bieumau">
                            <div class="col-12 col-sm-4 col-lg-4">
                                <a href="${path}/files/export-danh-sach-sv-da-dang-ky">
                                    <i class="fa fa-download" aria-hidden="true"></i> Xuất danh sách sinh viên đã đăng
                                    ký
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="m-portlet">
                            ...
                            <div class="m-portlet__body">
                                <div class="row">
                                    <div class="col-6">
                                        <label for="">Tổng số sinh viên đã đăng ký:</label>
                                        <h4 class="d-inline ml-4">${tongSVDaDK }</h4>
                                    </div>
                                ...
                                <table
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach var="item" items="${sinhVienDaDK }" varStatus="loop">
                                            <tr>
                                            	<td>${loop.count}</td>
                                                <!--  <td>${item[0] }</td>-->
                                                <!-- id -->
