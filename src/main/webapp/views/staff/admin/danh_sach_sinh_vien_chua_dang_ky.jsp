                    ...
                    <div class="mt-5">
                        ...
                        <section class="fillter-area  mb-5">
                            <div class="m-portlet">
                                ...
                                <form
                                    action="${path}/staff/admin/danh-sach-sinh-vien-chua-dang-ky/tim-kiem-sinh-vien-chua-dang-ky"
                                            ...
                                            <select class="form-control d-inline col-8 select2" name="chuyen_nganh_id"
                                                ...
                                                <c:forEach items="${chuyenNganh}" var="chuyenNganh">
                                                    ...
                                                    <option value="${chuyenNganh.id}"
                                                        ${chuyenNganh.id==sessionScope.ScopeCN_chuaDK ?"selected":""}>
                                        ...
                                        <div
                                            ...
                                            <select class="form-control col-8 select2" name="khoa" id="khoa">
                                                ...
                                                <c:forEach items="${khoa}" var="khoa">
                                                    <option value="${khoa}" ${khoa.equals(sessionScope.ScopeKhoa_chuaDK)
                                        ...
                                        <div
                                            ...
                                            <select class="form-control d-inline col-8 select2" name="dot_id"
                                                ...
                                                <c:forEach items="${dotdk}" var="dotdk">
                                                    <option value="${dotdk[0]}"
                                                        ${dotdk[0]==sessionScope.ScopeDotDK_chuaDK ?"selected":""}>
                                                        ${dotdk[1]}</option>
                                            ...
                                            <select class="form-control d-inline col-8 select2" name="co_so_id"
                                                ...
                                                <c:forEach items="${CoSo}" var="CoSo">
                                                    ...
                                                    <option value="${CoSo.id}"
                                                        ${CoSo.id==sessionScope.ScopeCoSo_chuaDK ?"selected":""}>
                                                        ${CoSo.ten}</option>
                                    ...
                                    <div class="row justify-content-center pt-2">
                                        ...
                                        <div class="col-sm-2 col-12 text-center mt-2">
                                            <a href="${path}/staff/admin/danh-sach-sinh-vien-chua-dang-ky"
                        ...
                        <div class="row mb-5 bieumau">
                            <div class="col-12 col-sm-4 col-lg-4">
                                <a href="${path}/files/export-danh-sach-sv-chua-dang-ky">
                                    <i class="fa fa-download" aria-hidden="true"></i> Xuất danh sách sinh viên chưa đăng
                                    ký
                                </a>
                            </div>
                        </div>
