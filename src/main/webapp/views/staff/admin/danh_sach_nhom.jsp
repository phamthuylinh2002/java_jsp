		...
		<%@taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
				...
				<div class="mt-5">
					...
					<section class="fillter-area  mb-5">
						<div class="m-portlet">
							...
							<form action="${path}/staff/admin/danh-sach-cac-nhom-da-tao/tim-kiem" method="post"
								...
								<div class="row">
									<div
										...
										<span for="" class="fillter-name col-4 text-center">Chuyên
											ngành</span> <select class="form-control d-inline col-8 select2"
											name="chuyen_nganh_id" id="chuyen_nganh_id" onchange="submitData(event)">
											<option value="0" selected>Chọn chuyên ngành</option>

											<c:forEach items="${chuyenNganh}" var="chuyenNganh">
												<option value="${chuyenNganh.id}"
													${chuyenNganh.id==sessionScope.ScopeCN_nhom ?"selected":""}>
									...
									<div
										...
										<span for="" class="fillter-name col-4 text-center">Giảng
											viên hướng dẫn</span> <select class="form-control col-8 select2"
											name="giang_vien_id" id="giang_vien_id">
								...
								<div class="row">
									<div
										...
										<span for="" class="fillter-name col-4 text-center">Đợt
											Đăng Ký</span> <select class="form-control d-inline col-8 select2"
											name="dot_id" id="dot_id">
									...
									<div
										...
										<span for="" class="fillter-name col-4 text-center">Số
											thành viên</span> <select class="form-control d-inline col-8 select2"
											name="so_thanh_vien" id="so_thanh_vien">
									...
									<div
										...
										<select class="form-control d-inline col-8 select2" name="co_so_id"
											id="co_so_id">
								...
								<div class="row justify-content-center pt-2">
									...
									<div class="col-sm-2 col-12 text-center mt-2">
										<a href="${path}/staff/admin/danh-sach-cac-nhom-da-tao"
					...
					<div class="row mb-5 bieumau">
						<div class="col-12 col-sm-4 col-lg-4">
							<a href="${path}/files/exportDSNhom">
								<!-- data-toggle="modal"
                        data-target="#export_ds_nhom">--><i class="fa fa-download" aria-hidden="true"></i> Xuất danh
								sách nhóm
							</a>
						</div>
					</div>
					...
					<form action="${path}/files/exportDSNhom" method="POST">
						<div class="modal fade" id="export_ds_nhom" tabindex="-1" role="dialog"
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										<div class="col-12 mt-4">
											<label>Chuyên ngành</label> <select name="chuyen_nganh_id"
												class="form-control col-12">
												<option value="0">Chọn chuyên ngành</option>

												<c:forEach items="${chuyenNganh}" var="chuyenNganh">
													<option value="${chuyenNganh.id}">${chuyenNganh.ten}</option>
												</c:forEach>

											</select>
										</div>
										<div class="col-12 mt-4">
											<label>Giảng viên hướng dẫn</label> <select name="giang_vien_id"
												class="form-control col-12">
									...
									<div class="modal-footer">
										...
										<button type="submit" onclick="closeModal('export_ds_nhom')"
									...
									<c:forEach var="item" items="${dSachNhom }" varStatus="loop">
										<tr>
											...
											<td><a class="btn btn-primary"
													href="${path}/staff/admin/chi-tiet-nhom?nhom_id=${item[0]}">
													Chi tiết nhóm </a></td>
										</tr>
									</c:forEach>
			...
			<script>
				function submitData(event) {
					...
					const cn_id = event.target.value;

					window.location.href = url + "?chuyen-nganh=" + cn_id
