                    ...
                    <div class="mt-5">
                        <section class="fillter-area  mb-5">
                            <div class="m-portlet">
                                ...
                                <form action="${path}/staff/admin/quan-ly-sinh-vien/tim-kiem" method="post" class="m-portlet__body">
                                    <div class="row">
                                        <div class="form-group d-inline col-md-6 col-12 d-flex justify-content-around align-items-center">
                                            <span for="" class="fillter-name col-4 text-center">Từ
                                                khóa</span> <input type="text" class="form-control col-8" name="keyword" id="keyword">
                                        </div>
                                        <div class="form-group d-inline col-md-6 col-12 d-flex justify-content-around align-items-center">
                                            <span for="" class="fillter-name col-4 text-center">Chuyên
                                                ...
                                                <c:forEach items="${chuyenNganh}" var="chuyenNganh">
                                                    <option value="${chuyenNganh.id}"
                                                        ${chuyenNganh.id==sessionScope.ScopeCN_DS ?"selected":""}>
                                                        ${chuyenNganh.ten}</option>
                                                </c:forEach>
                                        ...
                                        <div class="form-group d-inline col-md-6 col-12 d-flex justify-content-around align-items-center">
                                            ...
                                            <select class="form-control d-inline col-8 select2" name="dot_id" id="dot_id">
                                                ...
                                                <c:forEach items="${dotdk}" var="dotdk">
                                                    ...
                                                    <option value="${dotdk[0]}" ${dotdk[0]==sessionScope.ScopeDotDK_DS
                                        ...
                                        <div class="form-group d-inline col-md-6 col-12 d-flex justify-content-around align-items-center">
                                            ...
                                            <select class="form-control d-inline col-8 select2" name="co_so_id" id="co_so_id">
                                                <option value="0" selected>Chọn cở sở</option>

                                                <c:forEach items="${CoSo}" var="CoSo">

                                                    <option value="${CoSo.id}" ${CoSo.id==sessionScope.ScopeCoSo_QLSV
                                                        ?"selected":""}>
                                                        ${CoSo.ten}</option>
                                    ...
                                    <div class="row justify-content-center pt-2">
                                        ...
                                        <div class="col-sm-2 col-12 text-center mt-2">
                                            <a href="${path}/staff/admin/quan-ly-sinh-vien" class="btn btn-danger text-white"> Làm mới bộ lọc </a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Import Danh sách sinh viên
                                            </h5>
                        ...
                        <div class="modal fade" id="delete_dssv" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <form method="POST" id="form_delete_sv" action="${path}/files/delete-sv"
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <div class="modal fade" id="modal_create" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        <form method="POST" id="form_create_sv" onsubmit="return validate()" action="${path}/staff/admin/quan-ly-sinh-vien/insert">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Thêm sinh viên
                                                                </h5>
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                        ...
                                        <div class="col-6 d-inline">
                                            <div class="col-8 form-group m-form__group d-flex justify-content-end">
                                                <label for="">Tổng số nhân viên:</label>
                                                <h4 class="d-inline ml-4">${sizeDSSV}</h4>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <c:forEach var="item" items="${sinhVien }" varStatus="loop">
                                                <tr>
                                                    ...
                                                    <div class="modal fade" id="modal_edit_${item[0] }" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                <form method="POST" id="form_edit_sv_${item[0] }" onsubmit="return validateUpdate(${item[0]})" action="${path}/staff/admin/quan-ly-sinh-vien/edit/?idSv=${item[0] }">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="recipient-name" class="col-form-label">Họ
                                                                                và tên</label> <input type="text" class="form-control" value="${item[2] }" id="ten_sv_${item[0] }"
                                                                                required="required" maxlength="100" name="ten_sv"> <small class="text-danger" id="name_error_${item[0] }"></small>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="message-text" class="col-form-label">Mã
                                                                                sinh viên</label> <input type="text" class="form-control" required="required" maxlength="100" value="${item[1] }"
                                                                                name="ma_sv" id="ma_sv_${item[0] }">
                                                    ...
                                                    <div class="modal fade" id="modal_delete_${item[0] }" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                <form method="POST" id="form_delete_sv_${item[0] }" action="${path}/staff/admin/quan-ly-sinh-vien/delete/?idSv=${item[0] }">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="recipient-name" class="col-form-label">Họ
                                                                                và tên</label> <input type="text" class="form-control" value="${item[2] }" id="ten_sv_${item[0] }"
                                                                                disabled="disable"> <small class="text-danger" id="name_error_{{ item->id }}"></small>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="message-text" class="col-form-label">Mã
                                                                                sinh viên</label> <input type="text" class="form-control" value="${item[1] }" name="ma_sv" id="ma_sv_${item[0] }"
                                                                                disabled="disable">
                                                                            <small class="text-danger" id="ma_sv_error_${item[0] }"></small>
                                                                        </div>
